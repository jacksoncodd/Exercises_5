...
```
```{r, echo=FALSE}
knitr::include_graphics("name_by_year.gif")
```
...
```{r, echo=FALSE}
knitr::include_graphics("bikers_by_wday.gif")
```
...
```{r, echo=FALSE}
knitr::include_graphics("delay_station.gif")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("mallorca_path.gif")
```
...
```{r, echo=FALSE}
knitr::include_graphics("state_cases.gif")
```
...
```{r, echo=FALSE}
knitr::include_graphics("state_10000.gif")
```
...
[link](https://github.com/jacksoncodd/Exercises_5/blob/master/05_exercises.md)
